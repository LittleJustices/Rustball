...
#[commands(atom, booru, dailybird, dailyfox, dailywitch, shadow, squid, them, unyu, yuru)]
struct Funsies;
...
#[commands(roll, modify, reroll, pastrolls, exroll, genroll, l5r, s3roll, sr, cofd, verbose)]
struct Dice;
